...
class NodeStorage {
    ...
    addEndpointParam(nodeName, endpointName, param, location) {
        ...
        if (location === types_1.ParameterLocation.Header) {
    ...
    addHeaderParam(nodeName, endpointName, param) {
        param.required = typeof param.required === 'boolean' ? param.required : false;
        this.addEndpointParam(nodeName, endpointName, param, types_1.ParameterLocation.Header);
    }
    createHeaderParam(nodeName, endpointName, name, type, required = false) {
        this.createEndpointParam(nodeName, endpointName, name, type, required, types_1.ParameterLocation.Header);
    }
    upsertHeaderParam(nodeName, endpointName, param) {
        param.required = typeof param.required === 'boolean' ? param.required : false;
        this.upsertEndpointParam(nodeName, endpointName, param, types_1.ParameterLocation.Header);
    }
...
//# sourceMappingURL=../../src/dist/storage/index.js.map