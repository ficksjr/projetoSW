...
export declare class NodeStorage {
    ...
    addHeaderParam(nodeName: string, endpointName: string, param: Parameter): void;
    createHeaderParam(nodeName: string, endpointName: string, name: string, type: string, required?: boolean): void;
    upsertHeaderParam(nodeName: string, endpointName: string, param: Parameter): void;
