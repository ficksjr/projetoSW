...
exports.Body = Body;
function Header(name, type, required) {
    return VariativeDataDecorator(name, types_1.ParameterLocation.Header, type, required);
}
...
//# sourceMappingURL=../../src/dist/decorators/variative.data.js.map